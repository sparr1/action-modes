...
_DEFINITIONS = {
    ...
    "actor_squashed_entropy_contribution": "Fixed ablation coefficient times joint tanh-corrected entropy in the TDAMBI actor objective.",
    "actor_entropy_contribution": "Weighted entropy bonus actually used by the TDAMBI actor objective; mode is recorded in the resolved configuration.",
    ...
    "tdambi_entropy_coef": "Fixed TDAMBI actor entropy coefficient for the selected mode; not SAC alpha.",
