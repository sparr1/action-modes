...
export_spec="ALL,EXPECTED_ACTION_MODES_SHA=$EXPECTED_ACTION_MODES_SHA,AMBIXQC_ACTION_MODES_DIR=$PROJECT_DIR,AMBIXQC_BENCHMARK_RESULTS_ROOT=$AMBIXQC_BENCHMARK_RESULTS_ROOT,AMBIXQC_PYTHON=$AMBIXQC_PYTHON,AMBIXQC_PAIR_ORDER=$AMBIXQC_PAIR_ORDER"
submit_command=(
  sbatch
  --parsable
  --chdir="$PROJECT_DIR"
