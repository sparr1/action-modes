...
def test_prior_comparator_clears_random_checkpoint_initialization(checkpoint_context):
    ...
    resolved = resolve_preset(MATRIX, "inner_budget/prior", checkpoint_context=checkpoint_context)
