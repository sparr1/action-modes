...
_RUNTIME_CONFIG_FIELDS = (
    ...
    "inner_search_active",
    "inner_search_family",
    "inner_uses_outer_leaf",
    "inner_uses_inner_target",
    "inner_uses_structured_replay",
    "inner_requires_behavior_log_prob",
    "inner_effective_target_update_event",
    ...
    "inner_component_update_schedule",
    ...
    "inner_explorer_active",
    "inner_param_noise_active",
    "inner_explorer_trainable",
    "inner_explorer_has_separate_critic",
    "inner_primary_rollouts_per_round",
    ...
    "inner_primary_target_rows_per_batch",
    "inner_explorer_target_rows_per_batch",
    "inner_primary_actor_updates_per_round",
    "inner_primary_critic_updates_per_round",
    "inner_primary_temperature_updates_per_round",
    "inner_primary_actor_updates_per_action",
    "inner_primary_critic_updates_per_action",
    "inner_primary_temperature_updates_per_action",
    "inner_explorer_actor_updates_per_action",
    "inner_explorer_critic_updates_per_action",
    "inner_explorer_temperature_updates_per_action",
    "inner_primary_optimizer_steps_per_action",
    "inner_explorer_optimizer_steps_per_action",
    "inner_total_optimizer_steps_per_action",
